...
API_ID = int(environ.get('API_ID',37770999 ''))
API_HASH = environ.get('API_HASH',4edba9115247bb0a3f29feeaec75831a '')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS',8557051570 '').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS',8557051570 '').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1003413322854 ''))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS',-1003338128026 '').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL',-1003413322854 '') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL',-1003413322854 '')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID',-1003521061791 '')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL',,-1003521061791 '')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI',mongodb+srv://DNDragon:<db_password>@cluster0.qzghxsl.mongodb.net/?appName=Cluster0 "")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "DNmovies")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'DNmovies')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Dnmoviesrequestgroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Dnmoviesrequestgroup')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Dnmoviesrequestgroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@MEEDRAGONBOT')
